...
function aside3_title_a_unbind() {
  // $("#aside3_title_a").click(function() {
  //   return false;
  // }); 能使超链接失效，但不能移除超链接
  if ($("body").find('.container').width() > 992) {
    $("#aside3_title_a").removeAttr("href");
  } else {
    $(".no_pjaxlink").removeClass(" pjaxlink ");
    // $("#aside3_title_a").unbind("click"); 激活超链接
  }
}
